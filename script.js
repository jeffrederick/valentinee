const CONFIG = {
    ...
    yesButton: "YES",
    noButton: "NO",
    noEscapeTexts: ["nononono ya😝", "Gabisa Jawa😜", "Aku anggep YES yahahayuq 💕"],
    confirmTitle: "YEAAAY! Kamu Beneran Mau 💗",
    confirmText: "From now you will be…",
    badgeText: "My Valentine",
    nextButton: "Next ",
    repeatButton: "Repeat",
    flowerTitle: "This lily flower is for a beautiful soul like you ⋆｡‧˚ʚɞ˚‧｡⋆",
    takeBouquetButton: "Take the Bouquet ",
    bouquetMessage: "Yeay! Now its Yours 💕",
    nextFlowerButton: "Next ",
    collageTitle: "Gallery of You (Cuma punya foto ini doang sih wkwk)",
    ...
    finalTitle: "Happy Valentine yaaa Dian 💞",
    finalMessage: `Kidung Agung 8:7 Air yang banyak tak dapat memadamkan cinta, sungai-sungai tak dapat menghanyutkannya.💕 
                         Happy Valentine 💕💕`,
